...
_This is NOT an official extension offered by Plausible_
...
_If Plausible Shield is synced for the first time to a new browser instance, you may need to
restart the browser to take effects._
